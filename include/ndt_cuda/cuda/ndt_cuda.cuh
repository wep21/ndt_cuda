#ifndef NDT_CUDA_NDT_CUDA_CUH
#define NDT_CUDA_NDT_CUDA_CUH
...
public:
  ...
  void set_distance_mode(ndt_cuda::NDTDistanceMode mode);
  void set_resolution(double resolution);
  void set_neighbor_search_method(ndt_cuda::NeighborSearchMethod method, double radius);
...
public:
  ndt_cuda::NDTDistanceMode distance_mode;
  double resolution;
